...
var chartDom = document.getElementById("map4B");
...
const legendData1 = Object.keys(dataByPart1).map(part => `${part} (${dataByPart1[part].length})`);
  ...
  .then((geojson) => {
    ...
    option = {
      ...
      series: [
        ...
        ...Object.keys(dataByPart1).map((part, index) => ({
          name: part,
          type: 'scatter',
          coordinateSystem: 'geo',
           symbol: 'pin',
          ...
          tooltip: {
            ...
            formatter: function (params) {
              if (params.seriesType === 'scatter') {
                return `${params.value[4]}<br/>開案數: ${params.value[2]}`;
              }
            }
          },
          data: dataByPart1[part],
